<?php
    ...
    try {
        ...
        // $sql="select a.jnNo, a.jnTitle, a.jnCont, a.jnDate, a.jnStart, a.jnEnd, b.mt , c.memID ,c.memImg from journal a, productkind b, member c where jnNo=:jnNo AND a.pdkNo=b.pdkNo";
        $sql="select a.jnNo, a.jnTitle, a.jnCont, a.jnDate, a.jnStart, a.jnEnd, a.pdkNo, b.mt , c.memID ,c.memImg ,c.memNo from journal a, productkind b, member c where jnNo=:jnNo AND a.memNo=c.memNo AND a.pdkNo=b.pdkNo";
        $jns=$pdo->prepare($sql);
        // $jnNo =4;
...
<head>
    ...
    <meta property="fb:admins" content="gina522125@yahoo.com.tw"/>
...
//    }(document, 'script', 'facebook-jssdk'));
    ...
    ?>
    <div class="jpBase" id="jnReport">
        <div class="jpWin">
            <div class="jpTitle">檢舉日誌</div>
            <div class="jpCont">
                <p>檢舉原因：</p>
                <form action="jnReport.php" method="get" id="jnReportForm">
                    <input type="hidden" value="<?php echo $jnRow['jnNo']?>" name="jnNo" id="jnNo">
                    <input type="hidden" value="<?php echo $jnRow['memNo']?>" name="memNo">
                    <!-- <input type="text" name="result" value="是否屏蔽"> -->
    
                    <div>
                        <input type="radio" id="jnSex" name="reason" value="內容包含暴力與色情">
                        <label for="jnSex">內容包含暴力與色情</label>
                    </div>
                    <div>
                        <input type="radio" id="jnAd" name="reason" value="內容為廣告">
                        <label for="jnAd">內容為廣告</label>
                    </div>
                    <div>
                        <input type="radio" id="jnOther" name="reason" value="">
    ...
    <div class="jnBg">
        <div class="jnMw1200">
            <div class="jnBread">
                ...
                <span><a href="journalsOverview.php">登山日誌</a></span>
                <i class="material-icons">keyboard_arrow_right</i>
            ...
            <div class="jnPaper">
                <div class="row jnJCC">
                    ...
                    <section id="jnContent">
                        <div id="jnContent__imgCtrl">
                            <img src="img/jn/<?php echo $jnRow['jnNo']?>/1.jpg" class="inContent__img">
                            <button id="jnIcon__fav">
                                <i class="material-icons" id="jnIcon__InFav">favorite_border</i>
                                <input type="hidden" name="collectNo" value="">
                            </button>
                        </div>
                    ...
                    <div id="jnContent__info">
                        <div id="jnContent__info--pos">
                            ...
                            <div class="jnContent__infoW">
                                ...
                                <br>
                                <span id="jnContent__writer">作者：<?php echo $jnRow['memID']?></span>
                                <br>
                                <span id="jnContent__publishTime">發表於<?php $jnDate = str_replace("-","/",$jnRow['jnDate']); echo $jnDate ?></span>
                            </div>
                            <div class="jnContent__infoJ">
                                <h3>行程日期：</h3>
                                <span id="jnContent__date"><?php $start = str_replace("-","/",$jnRow['jnStart']); echo $start ?> 
                                - 
                                <?php $end = str_replace("-","/",$jnRow['jnEnd']); echo $end?></span>
                                <h3>地點：</h3>
                                <span id="jnContent__locate"><?php echo $jnRow['mt']?></span>
                                <!-- <button id="btn__jnReport">檢舉日誌</button> -->
                                
                                    <!-- <input type="submit" id="btn__jnSeeProd" value="查看相關行程"> -->
                                    <button type="button" id="btn__jnSeeProd">
                                    <a href="product.php?pdkNo=<?php echo $jnRow['pdkNo']?>">查看相關行程</a>
                                    </button>
                                    <!-- <input type="submit" id="btn__jnSeeProd" value="查看相關行程"> -->
        ...
        <div class="jnMw1200">
            <div class="jnFB">
                <div class="jnFB__plr40">
                    <!-- <div class="fb-comments" data-href="http://140.115.236.71/demo-projects/CD105/CD105G3/journal.html" data-numposts="5" data-width="100%"></div> -->
                    <div class="fb-comments" data-href="http://140.115.236.71/demo-projects/CD105/CD105G3/jn.php?jnNo=<?php echo $jnRow['jnNo']?>" data-numposts="5" data-width="100%"></div>
                </div>
