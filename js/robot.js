var qaList = [
  ...
  { Q:"非洲",A:"非洲我們推薦吉力馬札羅山"},
  { Q:"預:推薦行程",A:"我們推薦阿爾卑斯山 -少女峰，少女峰屬於歐洲地區的熱門登山景點"},
  { Q:"預:技巧詢問",A:"詳情可以參考我們的登山技巧頁面"},
  { Q:"預:客製行程方法",A:"點選客製行程頁面後，在選擇洲別及山岳，之後確認行程景點順序後，選擇日期及嚮導並點擊訂購行程按鈕後就完成了"},
  { Q:"預:裝備詢問",A:""},
