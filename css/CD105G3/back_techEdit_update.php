...
<div id="breadcrumb">
    ...
    <i class="material-icons">keyboard_arrow_right</i>
    <span id="currentLoc">新增登山技巧</span>
</div>
        <form action="back_tech.php">
            ...
            <div class="editArea">
              ...
              <div class="row">
                ...
                <div class="col-20">
                  <input type="text" name="techTitle" value="">
                  <span></span>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-20">
                  <textarea type="text" name="techCont" cols="100" rows="10"></textarea>
                  <span></span>
                </div>
              </div>
            ...
            <div class="confirmArea">
              ...
              <button class="btn btnSubmit">確認新增</button>
            </div>
          </form>    
