...
$("#bannericon").click(()=>{
    ...
    <section class="index-warpper" id="index-stroke">
        ...
        $img="";
        for($i=0;$i<$levelArr[0]; $i++){ 
            $img .= '<i class="fas fa-hiking"></i>';
        }
        $img2="";
        for($i=0; $i<floor($avgRateArr[0]); $i++){ 
        ...
        <div class="stroke">
            ...
            <div id="money">
                <p class="stroke-me" id="stroke-day"><?php echo $pdkNameArr[0] ?></p>
                <p class="stroke-twd">NTD <span id="stroke-twd"><?php echo number_format($pdkPriceArr[0]); ?></span></p>
            </div>
   ...
   window.addEventListener("load",()=>{
    ...
    function imgsw(e,cl) {//撰寫函式
        ...
        if (index == 0) {
            ...
            // console.log(document.querySelector("#stroke-text").innerHTML);
        }else if(index ==6){
            var indextree1 = "";
            var indexeva1 = "";
            for (var i = 1; i <= <?php echo  $levelArr[6]?>; i++) {//之後要知道難度改變數字
    ...
    <section class="index-warpper" id="index-choose">
        ...
        <div id="chose-yesno">
            <section class="p12">
                <a href="#" id="p12-yes" data-content="YES">YES</a>
...
<div id="index-game-bg">
    ...
    <section class="index-warpper" id="index-game">
        ...
        <div id="game-1-svg">
            ...
            <div id="game-btn">
                <button class="btn" id="roll-game-btn">遊戲介紹</button>
            </div>
        </div>
    </section>
    ...
    <div class="jump-window" id="game-jw-1">
        <div class="ma-j">
            <div class="ju-w">
                <div class="h3-bg"></div>
                <h3>登山遊戲</h3>
                ...
                <div class="game-jw-btn">
                    <button id="jw-game1-clear1">返回</button>
                    <button id="jw-game1-go1">開始遊戲</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- 遊戲成功的區塊 -->
    <div class="jump-window" id="game-win-jw">
        <div class="ma-j">
            <div class="ju-w">
                <div class="h3-bg"></div>
                <h3>登山遊戲</h3>
                <p>恭喜獲得<span>50</span>點紅利點數，您可繼續參與其他遊戲以獲得更多的紅利點數！<span>另外登山請注重保暖喔~!</span></p>
                <div class="game-jw-btn">
                    <button id="jw-game1-clear2">離開</button>
                    <button id="jw-game1-go2">重新開始</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="jump-window" id="game-lose-jw">
        <div class="ma-j">
            <div class="ju-w">
                <div class="h3-bg"></div>
                <h3>登山遊戲</h3>
                <p>您已凍死在山上</p>
                <div class="game-jw-btn">
                    <button id="jw-game1-clear3">離開</button>
                    <button id="jw-game1-go3">重新開始</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="game-x-all">
        <div id="game-x">
            <span id="game-x-1"></span>
            <span id="game-x-2"></span>
        </div>
    </div>
   ...
   <?php  
   $sql = "SELECT  `memNo` , `pdkNo` , `jnNo` ,`jnTitle`,`jnCont` , MAX(jnCollect) AS MAXIMUM FROM `journal` GROUP BY `pdkNo` ";
...
?>
        ...
        if($pdkNoCard==3){
            ...
            ?>
        <div class="map-card asia-card" id="asia-card-1"alt="<?php echo $jnNo?>">
            <div class="card-none">
                <img class="map-card-img" src="img/jn/<?php echo $jnNo?>/1.jpg" alt="<?php echo $jnNo?>">
                <h3><?php echo $jnTitle?></h3>
                <p><?php echo $jnCont?></p>
                <div class="card-icon">
                    <span><i class="material-icons">favorite_border</i><?php echo $MAXIMUM ?></span><span><i
                    class="far fa-comment"></i>9</span>
                </div>
            </div>
        </div>
        ...
        <div class="map-card asia-card" id="asia-card-2"alt="<?php echo $jnNo?>">
            <div class="card-none">
                <img class="map-card-img" src="img/jn/<?php echo $jnNo ?>/1.jpg" alt="<?php echo $jnNo?>">
                <h3><?php echo $jnTitle?></h3>
                <p><?php echo $jnCont?></p>
                <div class="card-icon">
                    <span><i class="material-icons">favorite_border</i><?php echo $MAXIMUM ?></span><span><i
                            class="far fa-comment"></i>10</span>
                </div>
            </div>
        </div>
        ...
        <!-- ??? -->
        <div class="map-card asia-card" id="asia-card-3"alt="<?php echo $jnNo?>">
            <div class="card-none">
                <img class="map-card-img" src="img/jn/<?php echo $jnNo ?>/1.jpg" alt="<?php echo $jnNo?>">
                <h3><?php echo $jnTitle?></h3>
                <p><?php echo $jnCont?></p>
        ...
        <!-- 歐洲卡片 -->
        <!-- 少女峰 -->
        <div class="map-card europe-card" id="europe-card-1"alt="<?php echo $jnNo?>">
            <div class="card-none">
                <img class="map-card-img" src="img/jn/<?php echo $jnNo ?>/1.jpg" alt="<?php echo $jnNo?>">
                <h3><?php echo $jnTitle?></h3>
                <p><?php echo $jnCont?></p>
        ...
        <?php }else if($pdkNoCard==4){?>
            ...
            <div class="map-card oceania-card" id="oceania-card-1"alt="<?php echo $jnNo?>">
            <div class="card-none">
            <img class="map-card-img" src="img/jn/<?php echo $jnNo ?>/1.JPG" alt="<?php echo $jnNo?>">
            <h3><?php echo $jnTitle?></h3>
            <p><?php echo $jnCont?></p>
        ...
        <!-- 卡蘭 -->
        <div class="map-card namerica-card" id="namerica-card-1"alt="<?php echo $jnNo?>">
            <div class="card-none">
                <img class="map-card-img" src="img/jn/<?php echo $jnNo ?>/1.JPG" alt="<?php echo $jnNo?>">
                <h3><?php echo $jnTitle?></h3>
                <p><?php echo $jnCont?></p>
        ...
        <!-- 百內 -->
        <div class="map-card samerica-card" id="samerica-card-1"alt="<?php echo $jnNo?>">
            <div class="card-none">
                <img class="map-card-img" src="img/jn/<?php echo $jnNo ?>/1.jpg" alt="<?php echo $jnNo?>">
                <h3><?php echo $jnTitle?></h3>
                <p><?php echo $jnCont?></p>
        ...
        <!-- 卡 -->
        <div class="map-card samerica-card" id="samerica-card-2"alt="<?php echo $jnNo?>">
            <div class="card-none">
                <img class="map-card-img" src="img/jn/<?php echo $jnNo ?>/1.jpg" alt="<?php echo $jnNo?>">
                <h3><?php echo $jnTitle?></h3>
                <p><?php echo $jnCont?></p>
        ...
        <div class="map-card samerica-card" id="samerica-card-3"alt="<?php echo $jnNo?>">
            <div class="card-none">
                <img class="map-card-img" src="img/jn/<?php echo $jnNo ?>/1.jpg" alt="<?php echo $jnNo?>">
                <h3><?php echo $jnTitle?></h3>
                <p><?php echo $jnCont?></p>
        ...
        <!-- 非洲卡片 -->
        <!-- 馬札 -->
        <div class="map-card africa-card" id="africa-card-1"alt="<?php echo $jnNo?>">
            <div class="card-none">
                <img src="img/jn/<?php echo $jnNo ?>/1.jpg" alt="<?php echo $jnNo?>">
                <h3><?php echo $jnTitle?></h3>
                <p><?php echo $jnCont?></p>
                <div class="card-icon">
                    <span><i class="material-icons">favorite_border</i><?php echo $MAXIMUM ?></span><span><i
                    ...
                    <div class="eq-all">
                        <div class="people-equipment">
                            <div class="people-equipment-1" id="equipment-an-1">
                                ...
                                <input class="input-checkbox" type="checkbox" name="equipment1" id="equipment1" value="23">
                            ...
                            <div class="people-equipment-1" id="equipment-an-2">
                                ...
                                <input class="input-checkbox" type="checkbox" name="equipment2" id="equipment2" value="1">
                        ...
                        <div class="people-equipment">
                            <div class="people-equipment-1" id="equipment-an-3">
                                ...
                                <input class="input-checkbox" type="checkbox" name="equipment3" id="equipment3" value="22">
                            ...
                            <div class="people-equipment-1 " id="equipment-an-4">
                                ...
                                <input class="input-checkbox" type="checkbox" name="equipment4" id="equipment4" value="3">
                    ...
                    <div class="eq-all">
                        <div class="people-equipment">
                            <div class="people-equipment-1" id="equipment-an-5">
                                ...
                                <input class="input-checkbox" type="checkbox" name="equipment5" id="equipment5" value="14">
                            ...
                            <div class="people-equipment-1" id="equipment-an-6">
                                ...
                                <input class="input-checkbox" type="checkbox" name="equipment6" id="equipment6" value="17">
                        ...
                        <div class="people-equipment">
                            <div class="people-equipment-1 " id="equipment-an-7">
                                ...
                                <input class="input-checkbox" type="checkbox" name="equipment7" id="equipment7" value="18">
                            ...
                            <div class="people-equipment-1" id="equipment-an-8">
                                ...
                                <input class="input-checkbox" type="checkbox" name="equipment8" id="equipment8" value="2">
