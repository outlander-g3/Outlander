            ...
            <ul id="burgerText">
                ...
                <li v-if="web<768" id="member">會員專區
                    <ul id="member-child">
                        ...
                        <li><a class="member-a" href="memberOrders.php">訂單</a></li>
                        <li><a class="member-a" href="memberJournals.php">登山日誌</a></li>
                        <li><a class="member-a" href="memberEquip.php">行前裝備</a></li>
                    </ul>
                </li>
            </ul>
        </div>
